      ...
      getWithAuthorization('/wishlists')
          ...
          .done(function(response) {
            ...
            response['wishlists'].forEach(element => {
              ...
              let actions = "<td><button id='btnDel"+element['id'] +"' className='delbutton'>del</button></td>";
      ...
      getWithAuthorization('/shared-wishlists')
          .done(function(response) {
            ...
            response['sharedWishlists'].forEach(element => {
                ...
                let actions = "<td><button id='btnDelShared"+element['id'] +"' className='delbutton'>del</button></td>";
